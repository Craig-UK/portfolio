    ...
    <div>
      ...
      <div className="mt-5">
        <div id="contact-details">
          ...
          <p>Last Updated: 5th February 2024</p>
        </div>
        <div id="respect-your-privacy" className="mt-5">
          <h1 className="font-bold text-xl">2. How I Respect Your Privacy</h1>
          <p>
            This Privacy Policy applies to information that Just Craig
            Development Ltd collects about individuals who interact with me
            through this website. It explains what personal information I
            collect and how I use it.
          </p>
          <p className="mt-5">
            Just Craig Development Ltd is a company registered in Scotland with
            the company number SC797157.
          </p>
          <p className="mt-5">
        ...
        <div id="personal-info-collected-purposes" className="mt-5">
          ...
          <table className="mt-5">
            ...
            <tr>
              ...
              <td className="pl-5">
                Name, Email, Your Choice of Commission Plan &quot;Basic or
                Premium&quot; and The Reason for Your Commission Application
              </td>
              <td className="pl-5">
                Consent: You provide this data voluntarily to submit a
                commission application for either the Basic or Premium
                commission plans;
                <br />
                Contract: To undertake your requested commission, if your
                commission application has been accepted
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td className="pl-5">
                ...
                Businesses LinkedIn Page that you are applying for a commission
                on behalf of, Your Choice of Commission Plan
                &quot;Enterprise&quot; and The Reason for Your Commission
                Application
              </td>
              <td className="pl-5">
                Consent: You provide this data voluntarily to submit a
                commission application for the Enterprise commission plan;
                <br />
                Contract: To undertake your requested commission, if your
                commission application has been accepted
              </td>
        ...
        <div id="personal-info-used" className="mt-5">
          ...
          <ul className="mt-2 list-disc ml-5">
            ...
            <li>
              ...
              applications for all commission plans: &quot;Basic, Premium and
              Enterprise&quot;);
            </li>
            <li>
        ...
        <div id="data-retention" className="mt-5">
          ...
          <p>
            I take the principles of data minimisation and removal seriously and
            I will only ever ask for the minimum amount of data required for the
            associated purpose and delete that data promptly, once it is no
            longer required to be stored.
          </p>
          <p className="mt-5">Where your data is collected on the basis of:</p>
          <ul className="mt-2 list-disc ml-5">
            <li>Contract: 2 years for audit reasons;</li>
            <li>
              Consent: I will seek renewal of consent at least every 12 months.
            </li>
          </ul>
        </div>
        <div id="data-protection-rights" className="mt-5">
          ...
          <p>
            For a comprehensive list of your legal rights over your data, visit
            the Information Commissioner&apos;s Office (&quot;ICO&quot;)
            Website:{" "}
            <a className="underline" href="https://www.ico.org.uk">
          ...
          <ul className="mt-2 list-disc ml-5">
            <li>
              Where data processing is based on consent, you can revoke consent
              at any time by contacting me;
            </li>
            <li>
              Your right of access - You have the right to ask me for copies of
              your personal information;
            </li>
            <li>
              Your right to rectification - You have the right to ask me to
              rectify personal information you think is inaccurate. You also
              have the right to ask me to complete information you think is
              incomplete;
            </li>
            <li>
            ...
            <li>
              Your right to data portability - You have the right to ask that I
              transfer the personal information you gave me to another
              organisation, or to you, in certain circumstances.
            </li>
          </ul>
          <p className="mt-5">
            Note: Exercising certain rights, such as data deletion, may prevent
            me from delivering certain services to you.
          </p>
          <p className="mt-5">
          ...
          <p className="mt-5">
            ...
            Commissioner&apos;s Office (&quot;ICO&quot;) if you believe your
            rights have been violated. See{" "}
            <Link className="underline" href="#complaints">
              Section 10. How To Complain
            </Link>{" "}
            for more information and how to contact the Information
            Commissioner&apos;s Office (&quot;ICO&quot;).
          </p>
          <p className="mt-5">
            Please contact me at privacy@justcraigdev.com if you wish to make a
            request.
          </p>
        </div>
        <div id="cookies-usage" className="mt-5">
          ...
          <p>
            A cookie is a small file of letters and numbers that is downloaded
            on to your computer when you visit a website. Cookies allow a
            website to recognise a user&apos;s device and store some information
            about the user&apos;s preferences.
          </p>
          <p className="mt-5">
            I use cookies primarily for website functionality and not for
            collecting personal data beyond the purposes outlined in section 3
            above. Some cookies may gather anonymous usage data to improve
            website performance.
          </p>
        </div>
        <div id="privacy-policy-updates" className="mt-5">
          ...
          <p>
            I may update this privacy policy occasionally and will publish the
            most current version of this privacy policy to my website. If an
            update to this privacy policy meaningfully reduces your rights, I
            will notify people whose personal data that I hold and is affected
        ...
        <div id="complaints" className="mt-5">
          ...
          <p>
            If you have any concerns about my use of your personal information,
            you can make a complaint to me at privacy@justcraigdev.com.
          </p>
          <p className="mt-5">
            You can also complain to the ICO if you are unhappy with how I have
            used your data.
          </p>
